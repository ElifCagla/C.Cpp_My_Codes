#include <stdio.h> //standart giriþ çýkýþ iþlemlerini saðlayan kütüphane
#include <string.h> //karakter dizileri ile çalýþmamýzý saðlayan kütüphane
...
//strlen: 'strlen' fonksiyonu (kýsaltmasý "string length"), C dilinde bir karakter dizisinin (string) uzunluðunu bulmak için kullanýlýr.
//stdin:  bir iþaretçi olan stdin akýþý, genellikle klavyeden kullanýcý girdilerini okumak için kullanýlýr. 
//fgets: metin tabanlý girdi okumak için kullanýlan bir iþlevdir.
